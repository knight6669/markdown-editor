...
代码块高亮能力是预览体验的一部分，但它不只是“把代码染色”：

- 支持技术文档中常见的代码块展示
- 支持行内代码与代码块的阅读区分
- 预览区高亮样式会跟随整体主题气质协调变化
